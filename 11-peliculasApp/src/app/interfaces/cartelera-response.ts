// To parse this data:
//
//   import { Convert, CarteleraResponce } from "./file";
//
//   const carteleraResponce = Convert.toCarteleraResponce(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface CarteleraResponce {
    results:       Movie[];
    page:          number;
...
export class Convert {
    public static toCarteleraResponce(json: string): CarteleraResponce {
        return cast(JSON.parse(json), r("CarteleraResponce"));
    }

    public static carteleraResponceToJson(value: CarteleraResponce): string {
        return JSON.stringify(uncast(value, r("CarteleraResponce")), null, 2);
    }
}
